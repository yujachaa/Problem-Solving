...
public class Solution {
	/*
	 * Q. 안경이 없어 #문제요약 경근이는 알파벳 대문자로 이루어진 두 개의 문자열을 비교하는데 문자열의 알파벳에 들어있는 구멍의 개수가 같으면
	 * 같은 문자열로 판단함 입력 : 두 문자열 길이 각 10이하 출력 : SAME / DIFF #풀이시간 : 11 #메모리/시간 : #메인접근법
	 * 1. 완전탐색 2. 문자열에 담아서 contains로 확인? String.contains : true /false 반환
	 *  10000 개 중에 9661개 맞음..
	 *  B의 위치를 기억해야되나? 9883
	 */
